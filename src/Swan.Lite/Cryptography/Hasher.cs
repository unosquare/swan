...
namespace Swan.Cryptography
{
    ...
    public static class Hasher
    {
        ...
        [Obsolete("Use a better hasher.")]
        public static ReadOnlySpan<byte> ComputeMD5(string value, bool createHasher = false) =>
        ...
        /// <returns>The computed hash code.</returns>
        [Obsolete("Use a better hasher.")]
        public static ReadOnlySpan<byte> ComputeMD5(byte[] data, bool createHasher = false) =>
        ...
        /// </returns>
        [Obsolete("Use a better hasher.")]
        public static ReadOnlySpan<byte> ComputeSha1(string @this, bool createHasher = false)
        {
        ...
        /// </returns>
        public static ReadOnlySpan<byte> ComputeSha256(string value, bool createHasher = false)
        {
        ...
        /// </returns>
        public static ReadOnlySpan<byte> ComputeSha512(string value, bool createHasher = false)
        {
            var inputBytes = Encoding.UTF8.GetBytes(value);
