namespace Unosquare.Swan.Test
{
    ...
    public class ConcurrentDataDictionaryTest
    {
        ...
        {
            Assert.DoesNotThrow(
                () => new ConcurrentDataDictionary<string, string>().Void());
        }
        ...
        public void ConstructorWithCollection_OnNullCollection_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(
                () => new ConcurrentDataDictionary<string, string>((IEnumerable<KeyValuePair<string, string>>)null).Void());
        }
        ...
        {
            Assert.DoesNotThrow(
                () => new ConcurrentDataDictionary<string, string>(InitialData).Void());
        }
        ...
        {
            Assert.DoesNotThrow(
                () => new ConcurrentDataDictionary<string, string>((IEqualityComparer<string>)null).Void());
        }
        ...
        {
            Assert.DoesNotThrow(
                () => new ConcurrentDataDictionary<string, string>(StringComparer.OrdinalIgnoreCase).Void());
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(
                () => new ConcurrentDataDictionary<string, string>(null, StringComparer.Ordinal).Void());
        }
        ...
        {
            Assert.DoesNotThrow(
                () => new ConcurrentDataDictionary<string, string>(InitialData, null).Void());
        }
        ...
        {
            Assert.DoesNotThrow(
                () => new ConcurrentDataDictionary<string, string>(InitialData, StringComparer.OrdinalIgnoreCase).Void());
        }

        [Test]
        public void ConstructorWithCollectionAndComparer_CopiesNonNullValues()
        {
            var dict = new ConcurrentDataDictionary<string, string>(InitialData, StringComparer.OrdinalIgnoreCase);
            Assert.AreEqual(InitialCount, dict.Count);
        }
        ...
        [Test]
        public void ConstructorWithConcurrencyLevelAndCapacity_OnNonPositiveConcurrencyLevel_ThrowsArgumentOutOfRangeException()
        {
            Assert.Throws<ArgumentOutOfRangeException>(
                () => new ConcurrentDataDictionary<string, string>(0, 10).Void());
        }

        [Test]
        public void ConstructorWithConcurrencyLevelAndCapacity_OnNegativeCapacity_ThrowsArgumentOutOfRangeException()
        {
            Assert.Throws<ArgumentOutOfRangeException>(
                () => new ConcurrentDataDictionary<string, string>(4, -1).Void());
        }

        [Test]
        public void ConstructorWithConcurrencyLevelAndCapacity_Succeeds()
        {
            Assert.DoesNotThrow(
                () => new ConcurrentDataDictionary<string, string>(4, 10).Void());
        }

        [Test]
        public void ConstructorWithConcurrencyLevelCollectionAndComparer_OnNonPositiveConcurrencyLevel_ThrowsArgumentOutOfRangeException()
        {
            Assert.Throws<ArgumentOutOfRangeException>(
                () => new ConcurrentDataDictionary<string, string>(0, new Dictionary<string, string>(), StringComparer.Ordinal).Void());
        }

        [Test]
        public void ConstructorWithConcurrencyLevelCollectionAndComparer_OnNullCollection_ThrowsArgumentNullException()
        {
            Assert.Throws<ArgumentNullException>(
                () => new ConcurrentDataDictionary<string, string>(4, null, StringComparer.Ordinal).Void());
        }

        [Test]
        public void ConstructorWithConcurrencyLevelCollectionAndComparer_OnNullComparer_Succeeds()
        {
            Assert.DoesNotThrow(
                () => new ConcurrentDataDictionary<string, string>(4, InitialData, null).Void());
        }

        [Test]
        public void ConstructorWithConcurrencyLevelCollectionAndComparer_Succeeds()
        {
            Assert.DoesNotThrow(
                () => new ConcurrentDataDictionary<string, string>(4, InitialData, StringComparer.OrdinalIgnoreCase).Void());
        }

        [Test]
        public void ConstructorWithConcurrencyLevelCollectionAndComparer_CopiesNonNullValues()
        {
            var dict = new ConcurrentDataDictionary<string, string>(4, InitialData, StringComparer.OrdinalIgnoreCase);
            Assert.AreEqual(InitialCount, dict.Count);
        }
        ...
        {
            IReadOnlyDictionary<string, string> dict = new ConcurrentDataDictionary<string, string>(InitialData);
