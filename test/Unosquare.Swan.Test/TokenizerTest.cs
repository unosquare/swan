namespace Unosquare.Swan.Test
{
    ...
    public class TokenizerTest
    {
        ...
        [TestCase("=10 mod 10", new[] { "10", "mod", "10" },
            new[] { TokenType.Number, TokenType.Operator, TokenType.Number })]
        [TestCase("=10 and -10", new[] { "10", "and", "-10" },
            new[] { TokenType.Number, TokenType.Operator, TokenType.Number })]
        ...
        [TestCase("=First(Global!PageNumber.Value,1)", new[] { "first", "(", "Global!PageNumber.Value", "1", ")" },
